...
def make_pagination_range(
    ...
    midlle_range = math.ceil(qty_pages / 2)
    ...
    return {
        ...
        'firt_page_out_of_range': current_page < midlle_range,
...
def make_pagination(request, queryset, per_page, qty_pages=4):
    ...
    try:
        current_page = int(current_page)  # Converte para inteiro
    except ValueError:
        current_page = 1  # Se a conversão falhar, define como 1
